...
Хранит данные о работе приложения (данные по заказу, каталогу товаров, ошибки форм, карточки для превью, корзине). Имеет методы:
...
- toggleCardInBasket, добавляет товар в корзину или удаляет его в случае если он уже был добавлен
